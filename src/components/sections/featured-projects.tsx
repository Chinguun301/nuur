...
const projects = [
  ...
  },
  {
    ...
    description:
      "Real-time chat application powered by AI with natural language processing and image generation.",
  ...
  },
  {
    ...
    description: "A comprehensive component library with 50+ accessible, themeable UI components.",
