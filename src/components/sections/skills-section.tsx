...
const skillCategories = [
  ...
  },
  {
    ...
    icon: Palette,
    skills: [
      { name: "Flutter (iOS)", level: 90 },
      { name: "Flutter (Android)", level: 90 },
      { name: "Cross-Platform Dev", level: 88 },
  ...
  },
  {
    ...
    icon: Server,
    skills: [
      { name: "Mongolian (Native)", level: 100 },
      { name: "Chinese (HSK 5)", level: 95 },
      { name: "English (Advanced)", level: 80 },
      { name: "Translation", level: 85 },
    ],
  },
];
