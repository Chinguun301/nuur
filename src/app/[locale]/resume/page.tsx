...
const workExperience = [
  {
    ...
    position: "Front-end хөгжүүлэгч (Flutter)",
    period: "2025-03-08 - 2026-05-01",
    duration: "1 жил 2 сар",
    description:
      "Flutter ашиглан iOS болон Android зориулалттай хоёр мобайл апп хөгжүүлсэн. Vue.js ашиглан вэб сайт болон хяналтын панел боловсруулсан. Системд Админ, Дэд Админ, Клиент, Эмч гэсэн дүрүүд байжээ. Баг удирдаж байсан туршлага байхгүй.",
...
const awards = [
  ...
  },
  {
    year: "2018",
    items: [
      "Улсын тэргүүний лаборатори 1 дүгээр бүрэн дунд сургуулийн сагсан бөмбөгийн аварга шалгаруулах тэмцээн (2016, 2017, 2018 он) - алтан медаль",
      "Улсын тэргүүний лаборатори 1 дүгээр бүрэн дунд сургуулийн гар бөмбөгийн аварга шалгаруулах тэмцээн (2016, 2017, 2018 он) - мөнгөн, алтан, алтан медаль",
      "Шанхай хотын Зүүн хятадын шинжлэх ухаан технологийн их сургуулийн гар бөмбөг болон сагсан бөмбөгийн аварга шалгаруулах тэмцээн - алтан, хүрэл медаль",
    ],
  },
  {
    year: "2015",
    items: [
      "Улсын тэргүүний лаборатори 1 дүгээр бүрэн дунд сургуулийн математикийн олимпиад (2015, 2018 он) - мөнгөн медаль",
      "Улсын тэргүүний лаборатори 1 дүгээр бүрэн дунд сургуулийн физикийн багын олимпиад - хүрэл медаль",
    ],
  },
];
...
const skills = {
  personal: [
    ...
    { name: "Орчуулга хийх чадвар", icon: Languages },
  ],
  languages: [
    { name: "Хятад хэл", level: "Бүрэн эзэмшсэн (HSK түвшин - 5)", icon: Languages },
    { name: "Англи хэл", level: "Ахисан шат", icon: Languages },
    { name: "Монгол хэл", level: "Төрөлхийн", icon: Languages },
  ],
  computer: [
